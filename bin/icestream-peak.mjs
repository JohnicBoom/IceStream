...
function emitFrame(buf) {
  const samples = new Float32Array(buf.buffer, buf.byteOffset, frameSamples)
  const peak = spectrum.peakFromPcm(samples)
  process.stdout.write(JSON.stringify({ peak: peak }) + "\n")
}
