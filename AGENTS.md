...
- The running Omarchy copy is a **separate folder** under `~/.config/omarchy/plugins/io.github.johnicboom.icestream`. Copy files there to test; do not assume Work edits are live.
